...
{ "id": 7, "result": { "rateLimits": { "primary": { "usedPercent": 25, "windowDurationMins": 15, "resetsAt": 1730947200 }, "secondary": null, "rateLimitReachedType": null, "currentUsageLimitNudge": { "key": "near_limit_75_add_credits", "threshold": 75, "copyVariant": "add_credits" } } } }
...
- `currentUsageLimitNudge` is the current backend-selected near-limit prompt state; it may be an object, `null`, or omitted.
